...
public class BookEvent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblBookEvent.setBounds(240, 10, 170, 40);
        ...
        jLabel6.setBounds(20, 270, 130, 17);

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("NO. OF GUESTS : ");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(20, 320, 160, 17);
        ...
        EventType.setBounds(150, 80, 150, 30);
        ...
        txtVenueName.setBounds(150, 120, 150, 30);
        getContentPane().add(txtFoodName);
        txtFoodName.setBounds(150, 220, 150, 30);
        ...
        txtEquipment.setBounds(150, 270, 150, 30);
        ...
        txtGuest.setBounds(150, 320, 150, 30);
        ...
        btnConfirm.setBounds(70, 410, 130, 30);
        ...
        jButton1.setBounds(340, 410, 110, 30);
        ...
        lblErrorEvent.setBounds(310, 80, 130, 20);
        getContentPane().add(Date);
        Date.setBounds(150, 180, 189, 20);
