...
public class Registration extends javax.swing.JFrame {
    ...
    public static boolean valmob(String mob){
       return mob.length()==10 && mob.matches("[0-9]+");
    }
    ...
    private void initComponents() {
        ...
        lblpassword.setBounds(30, 400, 193, 17);
        ...
        lblconfirm.setBounds(30, 480, 180, 20);
        ...
        lblemail.setBounds(40, 180, 100, 20);
        ...
        txtname.setBounds(280, 70, 220, 30);
        ...
        jScrollPane1.setBounds(280, 250, 220, 96);
        ...
        btnReset.setBounds(280, 540, 130, 40);
        ...
        btnBack.setBounds(460, 20, 110, 30);
        ...
        lblErrorPassword.setBounds(280, 440, 220, 14);
    ...
    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
        ...
        if (txtname.getText().equals("")) {
            lblErrorName.setText("*Name Field cannot be Empty");
        }
        if (txtMobileNo.getText().equals("")) {
            lblErrorMobileNo.setText("*MobileNo. Field cannot be Empty");
        }
        if (txtEmail.getText().equals("")) {
            lblErrorEmail.setText("*Email Field cannot be Empty");
        }
        if (txtAddress.getText().equals("")) {
            lblErrorAddress.setText("*Address Field cannot be Empty");
        }
        if (pwdPassword.getText().equals("")) {
            lblErrorPassword.setText("*Password Field cannot be Empty");
        }
        if (pwdConfirmPassword.getText().isEmpty()) {
            lblConfirmPasswordError.setText("*Field cannot be Empty");
